    ...
    <aside class="app-sidebar" :class="{ 'sidebar-open': isSidebarOpen, 'sidebar-collapsed': isCollapsed }">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-group">
          ...
          <router-link to="/requirements" class="nav-item" active-class="nav-item-active" :class="{ 'nav-item-active': $route.name === 'requirements' || $route.name === 'requirement-categories' }" style="display: flex; align-items: center; justify-content: space-between; padding-right: 8px;">
            <div style="display: flex; align-items: center; gap: 12px; min-width: 0; flex: 1;">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="nav-icon" style="flex-shrink: 0;">
                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
              </svg>
              <span class="nav-text" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">需求管理</span>
            </div>
            <router-link to="/requirements/categories" class="header-action-btn" title="管理需求分类" @click.stop style="display: flex; align-items: center; justify-content: center; color: rgba(255, 255, 255, 0.4); transition: color 0.15s; cursor: pointer; padding: 4px; border-radius: 4px;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255, 255, 255, 0.4)'">
